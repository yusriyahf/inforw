...
<body>
            ...
            <div class="row align-self-center gy-4">
              ...
              <div class="col-md-6" data-aos="zoom-out" data-aos-delay="200">
                <div class="feature-box d-flex align-items-center">
                  ...
                  <h3>Efisiensi Waktu: Semua urusan bisa diselesaikan dari rumah.</h3>
                </div>
              </div>
              ...
              <div class="col-md-6" data-aos="zoom-out" data-aos-delay="300">
                <div class="feature-box d-flex align-items-center">
                  <i class="bi bi-check"></i>
                  <h3>Akses Mudah: Bisa diakses kapan saja dan di mana saja.</h3>
                </div>
              </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="member-img">
                <img src="/landingpage/img/maul.jpeg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
    ...
    {{-- <section id="recent-blog-posts" class="recent-blog-posts">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="post-box">
              <div class="post-img"><img src="/landingpage/img/blog/blog-1.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-4">
            <div class="post-box">
              <div class="post-img"><img src="/landingpage/img/blog/blog-2.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-4">
            <div class="post-box">
              <div class="post-img"><img src="/landingpage/img/blog/blog-3.jpg" class="img-fluid" alt=""></div>
  ...
  <section id="footer" class="footer">
    <footer id="footer" class="footer">
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-2 col-6 footer-links">
              ...
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/maulana-arya-80296625a/">Maulana Arya Putra Nugraha</a></li>
                <li><a href="https://www.linkedin.com/in/putri-aliciawati-450247181/">Putri Ayu Aliciawati</a></li>
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>Milku</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
