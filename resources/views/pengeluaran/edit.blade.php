        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="d-flex align-items-center">
              <p class="mb-0">Edit Data Pengeluaran</p>
            </div>
          </div>
          <div class="card-body">
            <form action="/pengeluaran/{{ $data->pengeluaran_id }}" method="POST">
                @method('put')
                  @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control @error('jumlah') is-invalid @enderror" type="text" name="jumlah" id="jumlah" value="{{ old('jumlah', $data->jumlah) }}" autocomplete="off">
                  @error('jumlah')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
             ...
             <div class="col-md-10">
              ...
              <div class="col-md-2">
                <div class="d-flex justify-content-end">
                  <a href="/pengeluaran" class="btn btn-danger btn-sm me-2">Batal</a>
