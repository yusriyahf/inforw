    ...
    <div class="row">
      <div class="col-md-10">
        <div class="card">
          ...
          <div class="card-body">
            <form action="/pengaduan/{{ $pengaduan->pengaduan_id}}" method="POST">
                @method('put')
                @csrf
            ...
            <div class="row">
              ...
              {{-- <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="user" id="user" value="{{ old('user', $pengaduan->user) }}">
                    @error('user')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
              ...
              {{-- <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="rw" id="rw" value="{{ old('rw', $pengaduan->rw) }}">
                    @error('rw')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
              ...
              {{-- <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="rt" id="rt" value="{{ old('rt', $pengaduan->rt) }}">
                    @error('rt')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $pengaduan->tempat_lahir) }}">
                    @error('tempat_lahir')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
