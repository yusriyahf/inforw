            ...
            <table class="table tables align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Total (dalam Rupiah)</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">
                    <span class="text-secondary text-xs font-weight-bold">{{ $d->total_bantuan }}</span>
                  </td>
                  <td class="align-middle text-center text-sm">
