            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" name="kk" id="kk" value="{{ old('kk') }}">
                    @error('kk')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="status_pernikahan" id="status_pernikahan" value="{{ old('status_pernikahan') }}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="status_keluarga" id="status_keluarga" value="{{ old('status_keluarga') }}">
