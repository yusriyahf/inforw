...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Welcome to Sistem Informasi RW</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>RW 3 Kelurahan Pandanwangi</h3>
            <p class="fst-italic">
                InfoRW ini bertujuan untuk mengembangkan sebuah sistem informasi berbasis web yang memfasilitasi administrasi dan pelayanan di tingkat Rukun Warga (RW). Sistem ini dirancang untuk membantu pengelolaan data penduduk, dokumentasi kegiatan, promosi dan pengelolaan usaha mikro, kecil, dan menengah (UMKM), serta penyaluran bantuan sosial (bansos) di lingkungan RW. Melalui pemanfaatan teknologi informasi, proyek ini bertujuan untuk meningkatkan efisiensi, akurasi, dan kualitas layanan di tingkat RW
            </p>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-3 col-md-5 mb-5 mb-md-0">
            <div class="info">
              <div class="address">
                <i class="bx bx-map"></i>
                <p>Pandanwangi<br>Rukun Warga 13</p>
              </div>

              <div class="email">
                <i class="bx bx-envelope"></i>
                <p>pandanwangirw13@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bx bx-phone-call"></i>
                <p>+62 822 3361 7717</p>
              </div>
            </div>
